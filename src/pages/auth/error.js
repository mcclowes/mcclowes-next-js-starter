            ...
            <div className="col-sm-8 mr-auto ml-auto mb-5">
              <div className="text-muted">
                ...
                <p className="mb-3">
                  ...
                  using another service you must link accounts before you can
                  use a different service to sign in.
                </p>
                <h4 className="mb-2">How do I fix this?</h4>
                <p className="mb-0">
                  To sign in using another service, first sign in using your
                  email address then link accounts.
                </p>
              </div>
            </div>
          </div>
